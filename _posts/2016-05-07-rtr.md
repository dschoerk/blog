...
img: post_rtr_preview.png
excerpt: test
excerpt_separator: "<!--excerpt-->"
---

# Installation: 
Fork the ``master`` <!--excerpt--> branch and delete ``gh-pages`` branch in it. This is important because ``gh-pages`` branch is used here only to host the blog. You should be using the master branch as 
the source and create a fresh ``gh-pages`` branch.
